    ...
    try {
      const res = await fetch('https://api.web3forms.com/submit', {
        ...
        body: JSON.stringify({
          ...
          subject: `Quote Request from ${formData.companyName} – SVS Polymer Industries`,
          from_name: formData.contactPerson,
          ...formData,
          customization: formData.customization.join(', ') || 'None',
        }),
      });
                  ...
                  {submitted ? (
                    <div className="flex flex-col items-center justify-center py-16 text-center">
                      ...
                      <p className="text-muted-foreground mb-6">
                        Our sales team will contact you within 24 hours with a detailed quotation.
                      </p>
